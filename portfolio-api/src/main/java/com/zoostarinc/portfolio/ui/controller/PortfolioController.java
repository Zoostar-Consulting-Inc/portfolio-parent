...
public class PortfolioController {
	...
	public ResponseEntity<Map<String, PositionSummary>> summary(@AuthenticationPrincipal OidcUser user) {
	...
	public ResponseEntity<Map<String, List<PositionEntityResponse>>> detail(@AuthenticationPrincipal OidcUser user) {
